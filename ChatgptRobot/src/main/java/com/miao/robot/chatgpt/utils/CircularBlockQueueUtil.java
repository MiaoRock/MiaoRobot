 ...
 * 创建时间： 2024/1/26 5:23 PM
 * 当前版本： 1.0
 *
 * @author zhaodezhi
 */
public class CircularBlockQueueUtil<E> extends CircularQueueUtil<E> {
    /**
     * 对添加，删除，指针移动操作加锁
     */
    ...
    public CircularBlockQueueUtil() {
        super();
    }

    public CircularBlockQueueUtil(QueueListener listener) {
